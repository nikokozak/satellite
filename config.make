...
################################################################################
PROJECT_EXTERNAL_SOURCE_PATHS = /opt/homebrew/opt/giflib
...
PROJECT_LDFLAGS += -L/opt/homebrew/opt/giflib/lib -lgif
...
#   Note: Leave a leading space when adding list items with the += operator
################################################################################
PROJECT_CFLAGS += -I/opt/homebrew/opt/giflib/include
